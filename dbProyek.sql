...
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Irma Gethouse', 'igethouse0', 'GRUHavvAj3cU');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Lorne Feldmesser', 'lfeldmesser1', 'u4euB4Bct');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Sheelah Pinwell', 'spinwell2', '2UooHj');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Harmon Thornally', 'hthornally3', 'mpK42I');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Vinita Danilewicz', 'vdanilewicz4', 'RWF5iAgU');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Saraann Mingay', 'smingay5', 'CisWO7vxxbq');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Waldon Friary', 'wfriary6', '77nOBsa1');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Gallard Harmour', 'gharmour7', 'FoHOVn1zZ');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Bryan Winram', 'bwinram8', 'xXF7aTGAKX');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Cass Manger', 'cmanger9', 'ctGg4MCrA');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Ryon Baggally', 'rbaggallya', 'pepJy8RZfv');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Alayne Ferby', 'aferbyb', 'fZ1Abl');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Zelig Rennebach', 'zrennebachc', 'KBVUpiZTV');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Ramona Hayler', 'rhaylerd', 'gaBVXbCPgha');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Babb Pavolini', 'bpavolinie', 'ZrYXpH');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Loni Cawthorn', 'lcawthornf', 'u8gTse');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Rusty O''Mahoney', 'romahoneyg', 'cugcom');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Johna Benech', 'jbenechh', 'FjqjYE');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Berty Moakes', 'bmoakesi', 'HdLxOONeFgA');
insert into PEGAWAI (KDPEGAWAI, NAMAPEGAWAI, USERNAME, PASSWORD) values ('', 'Padraic Cripin', 'pcripinj', 'qNnFkW63JShC');
